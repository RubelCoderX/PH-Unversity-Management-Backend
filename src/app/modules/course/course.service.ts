...
const updateCourseIntoDB = async (id: string, payload: Partial<TCourse>) => {
  ...
  try {
    ...
    // check if there is any preRequisitsCourses to update
    if (preRequisiteCourses && preRequisiteCourses.length > 0) {
      ...
      // filter out the new preRequisiteCourse fields
      ...
      if (!newPreRequisiteCourses) {
        throw new AppError(
          ...
          'Failed to newPreRequisiteCorse update',
        );
      }
    }
